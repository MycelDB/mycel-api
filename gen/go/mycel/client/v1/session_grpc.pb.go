...
func (UnimplementedSessionServiceServer) HeartbeatSession(context.Context, *HeartbeatSessionRequest) (*HeartbeatSessionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method HeartbeatSession not implemented")
}
...
func (UnimplementedTransactionServiceServer) CloseTransaction(context.Context, *CloseTransactionRequest) (*CloseTransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CloseTransaction not implemented")
}

...
func (UnimplementedAuthServiceServer) ListAuthSessions(context.Context, *ListAuthSessionsRequest) (*ListAuthSessionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListAuthSessions not implemented")
}
func (UnimplementedAuthServiceServer) RevokeAuthSession(context.Context, *RevokeAuthSessionRequest) (*RevokeAuthSessionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RevokeAuthSession not implemented")
}
func (UnimplementedAuthServiceServer) RevokeOtherAuthSessions(context.Context, *RevokeOtherAuthSessionsRequest) (*RevokeOtherAuthSessionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RevokeOtherAuthSessions not implemented")
}
